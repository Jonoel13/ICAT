...
<div class="col-md-11 offset-md-2">
  ...
  <form method="POST" action="{{url('registro/guardar')}}" autocomplete="off" enctype="multipart/form-data">
    ...
    <div class="form-row">
      ...
      <input type="hidden" name="enrol_group_id" value="EC1331-0001" >
    ...
    <div class="form-row">
      ...
      <div class="form-group col-md-6">
        ...
        <input type="file" class="form-control" id="enrol_user_doc_curp" name="enrol_user_doc_curp" placeholder="" value="{{ old('enrol_user_doc_curp') }}">
      ...
      <div class="form-group col-md-6">
        ...
        <input type="file" class="form-control" id="enrol_user_doc_id" name="enrol_user_doc_id" placeholder="" value="{{ old('enrol_user_doc_id') }}">
