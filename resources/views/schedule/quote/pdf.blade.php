...
<div class="mb-5">
  <div id="capture" class="row-fluid container citas canvas_div_pdf">
    <div class="col-md-12">
        <h3 class="title-logo">Instituto de Capacitación para el Trabajo</h3>
        <h4 class="title-q">Cita para el proceso de evaluación</h4>
        <hr class="line">
    </div>
    <div class="row mb-5 ml-1">
        <div class="col-md-8">
          <h4 class="sub-title-q">Datos Personales</h4>
          <p class="text-gray">
            <span class="text-b text-gray">Nombre: </span>{{ $quote->quote_user_name }} {{ $quote->quote_user_ap_p }} {{ $quote->quote_user_ap_m }}
            <br>
            <span class="text-b text-gray">Curp: </span>{{ $quote->quote_user_curp }}
            <br>
            <span class="text-b text-gray">Correo electónico: </span>{{ $quote->quote_user_email }}
          </p>
          <hr class="line">
        ...
        <div class="col-md-12">
          <hr class="line">
          <h4 class="sub-title-q ">Requisitos</h4>
          <p>
            <span class="text-b text-green">
              Es importante que acudas PUNTUAL, tendrás 10 minutos de tolerancia como máximo, de no llegar a tiempo o no presentarte deberás de reagendar tu cita con 24 horas de anticipación a la cita programada, enviando un correo a ece.icatcdmx@gmail.com
            </span>
            </p>
            <p class="mt-4">
  ...
  <div id="descarga" class="">
      <button onclick="getPDF()" class="btn btn-success pull-left btn-lg mb-5">Descargar</button>
  </div>
</div>
