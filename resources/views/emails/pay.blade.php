...
<br>
@if($pay == 'Aceptado')
Ya puedes agendar tu cita para realizar el proceso de evaluación iniciando sesión en tu perfil <a href="https://icatcdmx.mx/sii/usuario/citas" target="_blank"><strong>iniciando sesión en tu perfil</strong></a>
@else
